...
The suite contains 383 tests in 29 files. `npm test` is the source of truth
...
**Rendered tests, 130, running in jsdom.** Twelve files, each opting in with a
`// @vitest-environment jsdom` docblock so the unit suite keeps running in node
and keeps its speed:

| File                                                         | Tests | What it covers                                                                                     |
| ------------------------------------------------------------ | ----- | -------------------------------------------------------------------------------------------------- |
| features/payments/paymentsLedger.test.tsx                    | 22    | Every payment, search, dates, sorting, the total, reversals, and the whole row opening its creator |
