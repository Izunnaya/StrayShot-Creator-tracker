...
export const dailyInstalls: DailyInstall[] = creators.flatMap((creator) => {
  const campaign = campaigns.find((item) => item.id === creator.campaignId)!
